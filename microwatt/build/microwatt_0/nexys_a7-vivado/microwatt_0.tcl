...
set_property generic {memory_size=16384 ram_init_file=/home/pe1576su/Desktop/slice/microwatt/fpga/hello_world.hex clk_input=100000000 clk_frequency=100000000 disable_flatten_core=false log_length=2048 uart_is_16550=true has_fpu=true has_btc=true } [get_filesets sources_1]
...
read_xdc {src/microwatt_0/fpga/nexys_a7.xdc}
read_vhdl -vhdl2008 {src/microwatt_0/fpga/clk_gen_plle2.vhd}
read_vhdl -vhdl2008 {src/microwatt_0/fpga/top-generic.vhdl}
